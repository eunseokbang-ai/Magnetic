      ...
      <div style={{ flex: 1, padding: 16, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", overflow: "auto" }}>
        {hasRaw && (
          <div style={{ width: "100%", maxWidth: width, display: "flex", alignItems: "center", gap: 16, marginBottom: 6, fontSize: 12 }}>
            ...
            <span style={{ color: "#a9631f" }}>━━ 처리 후 신호</span>
            <span style={{ color: "#8a7a5c", marginLeft: "auto" }}>
        ...
        >
          ...
          <path d={pathD} fill="none" stroke="#a9631f" strokeWidth="1.5" />
          {distance_m.map((d, i) =>
        ...
        <div style={{ fontSize: 12, color: "#8a7a5c", marginTop: 8, display: "flex", gap: 20, flexWrap: "wrap" }}>
          ...
          <span style={{ color: nExcluded > 0 ? "#dc2626" : "#8a7a5c" }}>● 빨간 점 = 제외된 포인트 ({nExcluded}개)</span>
        ...
        {onApplySmoothing && (
          <div style={{ marginTop: 10, display: "flex", alignItems: "center", gap: 10 }}>
            ...
            {selRange && (
              <button onClick={clearSelection} style={{ padding: "6px 10px", fontSize: 12, borderRadius: 6, border: "1px solid #ddd0b2", background: "white", cursor: "pointer" }}>
                선택 취소
              </button>
            )}
          </div>
